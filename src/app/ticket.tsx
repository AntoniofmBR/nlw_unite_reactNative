...
export default function Ticket(){
  ...
  return (
    <View className='flex-1 bg-green-500'>
      ...
      contentContainerClassName='px-8 -b-8'
      ...
      >
        ...
        <TouchableOpacity activeOpacity={0.7} className='mt-7' onPress={() => badgeStore.remove()}>
      ...
      <Modal visible={expandQRCode} statusBarTranslucent animationType='slide'>
        <View className='flex-1 bg-green-500 items-center justify-center'>
          ...
          >
            ...
            <Text className='text-sm text-orange-500 font-bold text-center mt-10'>
              Fechar QRCode
            </Text>
          </TouchableOpacity>
        </View>
